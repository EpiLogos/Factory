...
const COMMANDS: &[&str] = &[
    ...
    "attempt.owner-action", "attempt.task", "attempt.return", "attempt.receiving", "attempt.learn",
    ...
    "development.attempt.return", "development.attempt.receiving", "development.attempt.learn", "owner",
];
const CONTRACTS: &[&str] = &[
    ...
    crate::attempt_receiving::RECEIVING_ACTION, crate::attempt_receiving::RECEIVING_RECEIPT,
    crate::attempt_learning::LEARNING_ACTION, crate::attempt_learning::LEARNING_RECEIPT,
];
