...
cap.factory.native-cli,capability,,,,[],A developer or Agent needs a stable way to inspect and operate Factory.,"factory capabilities declares public contracts; build snapshot/refresh, bounded developmental Project/Journey/Run reads, Action invocation, and verify operate or validate native providers.","Native snapshots, developmental readings and receipts remain usable from shell and machine clients.",source-inspected; native CLI and developmental-read integration evidence executed 2026-09-08 (Factory all-target suite: 125 passed). Owner-world and desktop acceptance are not established.,agent-inference,../github-recovery-mirror/mirror/agent-system-design/issues/181.json;../github-recovery-mirror/mirror/agent-system-design/issues/181.comments.json,factory/src/cli.rs,factory/tests/native_cli.rs,factory.html#q1/product,,,"{""basis"": ""Source-recovered capability account; original verification limits retained in Markdown."", ""converted_from_sha256"": ""99e4e8737c1c481bcd25a49a0a02f21cf3c34d78041d709e58fc566a5da0bf20"", ""cli_commands"": [""build.snapshot"", ""build.refresh"", ""action.list"", ""action.invoke"", ""verify"", ""development.project"", ""development.journey"", ""development.run"", ""development.action""], ""cli_exposure"": {""kind"": ""direct"", ""reason"": ""The native factory executable declares and handles these command families.""}, ""maintenance"": {""updated_at"": ""2026-09-08"", ""change_refs"": [""codex:thread:01a07608-d2ec-7b10-9713-74c445adf8a5"", ""../github-recovery-mirror/mirror/agent-system-design/issues/181.json"", ""reconcile:factory-pr-194"", ""https://github.com/EpiLogos/agent-system-design/pull/202""], ""code_basis"": {""factory/src/cli.rs"": ""eda9639937834d7287064f01b02cff11a06e5d56c5f2243044ada883ff8cb373""}}, ""last_reconciled_at"": ""2026-09-08T20:47:45.011637+00:00""}",
cap.factory.build-reading,capability,,,,[],A person needs the selected Project and Run’s current developmental state.,FactoryBuildFileProvider reads selected Build state; FactoryDevelopmentalState validates canonical Project/Journey/Run relations and exposes bounded native readings.,"Revisioned Build and developmental readings expose canonical Journey/Run state, frontier, RunMap, correlations and currently applicable Actions.","source-inspected; Factory all-target suite and strict Clippy executed green 2026-09-08. WorkflowUnit publication, owner-world and desktop acceptance are not established.",agent-inference,../github-recovery-mirror/mirror/agent-system-design/issues/143.json;../github-recovery-mirror/mirror/agent-system-design/issues/143.comments.json,factory/src/build_provider.rs;factory/src/developmental_read.rs,factory/tests/build_file_provider.rs;factory/src/developmental_read.rs;contracts/factory/fixtures/developmental-read-cases.json,factory.html#q1/product,,,"{""basis"": ""Source-recovered capability account; original verification limits retained in Markdown."", ""converted_from_sha256"": ""99e4e8737c1c481bcd25a49a0a02f21cf3c34d78041d709e58fc566a5da0bf20"", ""cli_commands"": [""build.snapshot"", ""build.refresh"", ""action.list"", ""development.project"", ""development.journey"", ""development.run""], ""cli_exposure"": {""kind"": ""direct"", ""reason"": ""The native command directly returns the selected provider snapshot or its Action inventory.""}, ""maintenance"": {""updated_at"": ""2026-09-08"", ""change_refs"": [""codex:thread:01a07608-d2ec-7b10-9713-74c445adf8a5"", ""../github-recovery-mirror/mirror/agent-system-design/issues/143.json"", ""reconcile:factory-pr-194"", ""https://github.com/EpiLogos/agent-system-design/pull/202""], ""code_basis"": {""factory/src/build_provider.rs"": ""527ce717e1f48a394385ddd9cd489b8b5b5c318c621162492df8ce72da83eab5"", ""factory/src/developmental_read.rs"": ""620b0bc1e0a671f143e102de4922aa42c83585da4cfcdaeec80d3b2ccfc4ed0d""}}, ""last_reconciled_at"": ""2026-09-08T20:47:45.011637+00:00""}",
