...
cap.factory.native-cli,capability,,,,[],A developer or Agent needs a stable way to inspect and operate Factory.,"factory capabilities declares public contracts; build snapshot/refresh, bounded developmental Project/Journey/Run/WorkflowUnit reads, Action invocation, and verify operate or validate native providers.","Native snapshots, developmental readings and receipts remain usable from shell and machine clients.",source-inspected; native CLI and developmental-read integration evidence executed green 2026-09-08 (Factory all-target suite: 140 passed). Owner-world and desktop acceptance are not established.,agent-inference,../github-recovery-mirror/mirror/agent-system-design/issues/181.json;../github-recovery-mirror/mirror/agent-system-design/issues/181.comments.json,factory/src/cli.rs,factory/tests/native_cli.rs;factory/src/developmental_read.rs,factory.html#q1/product,,,"{""basis"": ""Source-recovered capability account reconciled against the #199 WorkflowUnit publication slice."", ""converted_from_sha256"": ""99e4e8737c1c481bcd25a49a0a02f21cf3c34d78041d709e58fc566a5da0bf20"", ""cli_commands"": [""build.snapshot"", ""build.refresh"", ""action.list"", ""action.invoke"", ""verify"", ""development.project"", ""development.journey"", ""development.run"", ""development.workflow-units"", ""development.workflow-unit"", ""development.action""], ""cli_exposure"": {""kind"": ""direct"", ""reason"": ""The native factory executable declares and handles these command families.""}, ""maintenance"": {""updated_at"": ""2026-09-08"", ""change_refs"": [""codex:thread:01a07608-d2ec-7b10-9713-74c445adf8a5"", ""../github-recovery-mirror/mirror/agent-system-design/issues/181.json"", ""reconcile:factory-pr-194"", ""https://github.com/EpiLogos/agent-system-design/pull/202"", ""https://github.com/EpiLogos/agent-system-design/issues/199""], ""code_basis"": {""factory/src/cli.rs"": ""175bea7805e31e7d7f598926eac2690c57ad48d38858c6a0209c53624e124181""}}, ""last_reconciled_at"": ""2026-09-08T21:49:34.078548+00:00""}",
cap.factory.build-reading,capability,,,,[],A person needs the selected Project and Run’s current developmental state.,FactoryBuildFileProvider reads selected Build state; FactoryDevelopmentalState validates canonical Project/Journey/Run relations and deterministically compiles authoritative workflow source for bounded WorkflowUnit reads.,"Revisioned readings expose canonical Journey/Run state and source-backed WorkflowUnit identity, requirements, graph relations, RunMap/Journey correlations and truthful absence of unestablished Agency/execution/telemetry.",source-inspected; Factory all-target suite (140 tests) and strict Clippy executed green 2026-09-08. Heterogeneous Agency and telemetry publication plus owner-world and desktop acceptance are not established.,agent-inference,../github-recovery-mirror/mirror/agent-system-design/issues/143.json;../github-recovery-mirror/mirror/agent-system-design/issues/143.comments.json,factory/src/build_provider.rs;factory/src/developmental_read.rs,factory/tests/build_file_provider.rs;factory/src/developmental_read.rs;contracts/factory/fixtures/developmental-read-cases.json;contracts/factory/developmental-read.schema.json,factory.html#q1/product,,,"{""basis"": ""Source-recovered capability account reconciled against source-backed #199 WorkflowUnit publication."", ""converted_from_sha256"": ""99e4e8737c1c481bcd25a49a0a02f21cf3c34d78041d709e58fc566a5da0bf20"", ""cli_commands"": [""build.snapshot"", ""build.refresh"", ""action.list"", ""development.project"", ""development.journey"", ""development.run"", ""development.workflow-units"", ""development.workflow-unit""], ""cli_exposure"": {""kind"": ""direct"", ""reason"": ""Native commands return bounded owner readings over persisted source-backed state.""}, ""maintenance"": {""updated_at"": ""2026-09-08"", ""change_refs"": [""codex:thread:01a07608-d2ec-7b10-9713-74c445adf8a5"", ""../github-recovery-mirror/mirror/agent-system-design/issues/143.json"", ""reconcile:factory-pr-194"", ""https://github.com/EpiLogos/agent-system-design/pull/202"", ""https://github.com/EpiLogos/agent-system-design/issues/199""], ""code_basis"": {""factory/src/build_provider.rs"": ""527ce717e1f48a394385ddd9cd489b8b5b5c318c621162492df8ce72da83eab5"", ""factory/src/developmental_read.rs"": ""aecaa3514348d116cd0f07d25b9b740ac871510795c34589f732d00a06f9c7bf""}}, ""last_reconciled_at"": ""2026-09-08T21:49:34.078548+00:00""}",
