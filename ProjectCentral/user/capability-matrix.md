...
cap.factory.native-cli,capability,,,,[],A developer or Agent needs a stable way to inspect and operate Factory.,"factory capabilities declares public contracts; build snapshot/refresh, bounded developmental Project/Journey/Run/WorkflowUnit/ExecutionTelemetry reads, run development-ledger observation recording and read-back, Action invocation, and verify operate or validate native providers.","Native snapshots, developmental and execution-telemetry readings, recorded development observations and receipts remain usable from shell and machine clients.","source-inspected; Factory all-target suite (169 tests), strict Clippy and Draft 2020-12 schema validation executed green 2026-09-09. A real Workcell 0b93a4a native CLI observation of a local process is preserved as owner evidence: CPU time and RSS were observed, CPU utilisation was owner-derived, and peak RSS/GPU/VRAM/network/storage remained unsupported without values. The fixture is not claimed as historical Factory execution; AIKit consumption, owner-world and desktop acceptance are not established.",agent-inference,../github-recovery-mirror/mirror/agent-system-design/issues/181.json;../github-recovery-mirror/mirror/agent-system-design/issues/181.comments.json,factory/src/cli.rs,factory/tests/native_cli.rs;factory/tests/development_observation_cli.rs;factory/src/developmental_read.rs,factory.html#q1/product,,,"{""basis"": ""Factory #199 consumption reconciled against Actuation model-usage/v1 at 5fefe920790b1beec05c258c9d65328539ba4e44 (schema sha256 42215b3f06dffe5bfba53b0f51db6400d5b8739098c4fb1275f7a006579615cb). Factory Workcell consumption is pinned to accepted Workcell 0b93a4af54ff3d547941d4af342e6a738c22e7af and workcell.resource-usage/v1 schema sha256 4e0e1cf8848ed1faf74bcc362976b47f81aad99b33eea458a789cb688f1b3d5f."", ""converted_from_sha256"": ""99e4e8737c1c481bcd25a49a0a02f21cf3c34d78041d709e58fc566a5da0bf20"", ""cli_commands"": [""build.snapshot"", ""build.refresh"", ""action.list"", ""action.invoke"", ""verify"", ""development.project"", ""development.journey"", ""development.run"", ""development.workflow-units"", ""development.workflow-unit"", ""development.execution-telemetry"", ""development.action"", ""development.observe"", ""development.observations""], ""cli_exposure"": {""kind"": ""direct"", ""reason"": ""The native factory executable declares and handles these command families.""}, ""maintenance"": {""updated_at"": ""2026-09-09"", ""change_refs"": [""codex:thread:01a07608-d2ec-7b10-9713-74c445adf8a5"", ""../github-recovery-mirror/mirror/agent-system-design/issues/181.json"", ""reconcile:factory-pr-194"", ""https://github.com/EpiLogos/agent-system-design/pull/202"", ""https://github.com/EpiLogos/agent-system-design/issues/199"", ""https://github.com/EpiLogos/Workcell/pull/64"", ""wiki-continuity:CASE-07-08-development-observation-surface"", ""https://github.com/EpiLogos/agent-system-design/issues/200""], ""code_basis"": {""factory/src/cli.rs"": ""504ce267f73dc57a0fc18396af7c973f9c3139e7a37e4d18ec9fa50c2e25e9c8"", ""factory/src/developmental_read.rs"": ""5ba79b8e7ff36472c1113e7f07d660cd544bd2c03708019d67733826f1586584"", ""scripts/validate_factory_interop.py"": ""bb5e03f804027362bf04c7b15db120dab745fa121ed8001a809706c9fde56458""}}, ""last_reconciled_at"": ""2026-09-09T11:53:49.067727+00:00""}",
cap.factory.build-reading,capability,,,,[],A person needs the selected Project and Run’s current developmental state.,FactoryBuildFileProvider reads selected Build state; FactoryDevelopmentalState validates canonical Project/Journey/Run/WorkflowUnit/Agency/Execution relations and deterministically publishes bounded developmental and ExecutionTelemetry reads over owner-native refs.,"Revisioned telemetry readings preserve Actuation model/provider identity and usage plus Workcell-owned process identity, bounded interval, CPU and memory observations exactly where owner evidence supplies them; cache, latency, cost and every unsupported or unavailable resource remain explicit.","source-inspected; Factory all-target suite (169 tests), strict Clippy and Draft 2020-12 schema validation executed green 2026-09-09. A real Workcell 0b93a4a native CLI observation of a local process is preserved as owner evidence: CPU time and RSS were observed, CPU utilisation was owner-derived, and peak RSS/GPU/VRAM/network/storage remained unsupported without values. The fixture is not claimed as historical Factory execution; AIKit consumption, owner-world and desktop acceptance are not established.",agent-inference,../github-recovery-mirror/mirror/agent-system-design/issues/143.json;../github-recovery-mirror/mirror/agent-system-design/issues/143.comments.json,factory/src/build_provider.rs;factory/src/developmental_read.rs,factory/tests/build_file_provider.rs;factory/src/developmental_read.rs;scripts/validate_factory_interop.py;contracts/factory/fixtures/developmental-read-cases.json;contracts/factory/fixtures/execution-telemetry-reading.json;contracts/factory/developmental-read.schema.json,factory.html#q1/product,,,"{""basis"": ""Factory #199 consumption reconciled against Actuation model-usage/v1 at 5fefe920790b1beec05c258c9d65328539ba4e44 (schema sha256 42215b3f06dffe5bfba53b0f51db6400d5b8739098c4fb1275f7a006579615cb). Factory Workcell consumption is pinned to accepted Workcell 0b93a4af54ff3d547941d4af342e6a738c22e7af and workcell.resource-usage/v1 schema sha256 4e0e1cf8848ed1faf74bcc362976b47f81aad99b33eea458a789cb688f1b3d5f."", ""converted_from_sha256"": ""99e4e8737c1c481bcd25a49a0a02f21cf3c34d78041d709e58fc566a5da0bf20"", ""cli_commands"": [""build.snapshot"", ""build.refresh"", ""action.list"", ""development.project"", ""development.journey"", ""development.run"", ""development.workflow-units"", ""development.workflow-unit"", ""development.execution-telemetry""], ""cli_exposure"": {""kind"": ""direct"", ""reason"": ""Native commands return bounded owner readings over persisted source-backed state.""}, ""maintenance"": {""updated_at"": ""2026-09-09"", ""change_refs"": [""codex:thread:01a07608-d2ec-7b10-9713-74c445adf8a5"", ""../github-recovery-mirror/mirror/agent-system-design/issues/143.json"", ""reconcile:factory-pr-194"", ""https://github.com/EpiLogos/agent-system-design/pull/202"", ""https://github.com/EpiLogos/agent-system-design/issues/199"", ""https://github.com/EpiLogos/Workcell/pull/64"", ""https://github.com/EpiLogos/agent-system-design/issues/200""], ""code_basis"": {""factory/src/build_provider.rs"": ""527ce717e1f48a394385ddd9cd489b8b5b5c318c621162492df8ce72da83eab5"", ""factory/src/developmental_read.rs"": ""5ba79b8e7ff36472c1113e7f07d660cd544bd2c03708019d67733826f1586584"", ""scripts/validate_factory_interop.py"": ""bb5e03f804027362bf04c7b15db120dab745fa121ed8001a809706c9fde56458""}}, ""last_reconciled_at"": ""2026-09-09T11:53:49.067727+00:00""}",
cap.factory.journey-continuity,capability,,,,[],A continuing outcome needs to outlive one bounded Run or session.,"Journey records participants, linked Runs, frontier, activity, Return and Recognition; accepted AIKit Routine invocation evidence can atomically open exactly one bounded Run in an active or paused Journey.",One continuing identity relates distinct transformations and preserves returned evidence without converting provider delivery or owner-attested authority into execution.,"source-inspected; real Factory provider and native-binary tests executed green 2026-09-09 across atomic admission, replay/conflict, invalid standing, concurrent admission, Explain traversal and deterministic conformance-state reads. AIKit evidence is pinned to accepted owner main 7864b3c; later authority revalidation and owner-world/desktop acceptance remain external.",agent-inference,../github-recovery-mirror/mirror/agent-system-design/issues/168.json;../github-recovery-mirror/mirror/agent-system-design/issues/168.comments.json;contracts/factory/routine-continuation-source-lock.json;contracts/factory/upstream/aikit.routine-invocation-evidence.v1.schema.json,factory/src/journey.rs;factory/src/routine_continuation.rs;factory/src/developmental_read.rs;factory/src/conformance.rs,factory/tests/routine_continuation.rs;factory/tests/developmental_conformance.rs;contracts/factory/routine-continuation.schema.json,factory.html#q1/continuity,,,"{""basis"": ""Factory-owned Journey continuation consumes accepted AIKit invocation evidence at 7864b3c700b26e90e7b814295c9a2675aae8dbf7 while preserving current-on-supplied-basis and owner-attested standing."", ""cli_commands"": [""development.admit-routine-continuation"", ""development.routine-continuation"", ""conformance.developmental-state""], ""cli_exposure"": {""kind"": ""direct"", ""reason"": ""The native Factory executable admits and explains the relation and generates validated conformance provider state.""}, ""maintenance"": {""updated_at"": ""2026-09-09"", ""change_refs"": [""../github-recovery-mirror/mirror/agent-system-design/issues/168.json"", ""https://github.com/EpiLogos/agent-system-design/issues/200"", ""https://github.com/EpiLogos/ai-kit/pull/251""], ""code_basis"": {""factory/src/journey.rs"": ""e91d5e20d9cf61fa47466c2122fd5d1f2a7c2eb7bff70e4e65a2968c55d248c2"", ""factory/src/routine_continuation.rs"": ""ff14fa4c1bb0c4b094891fb46236a341bb2a907cb479d1a253f21d4bda33355f"", ""factory/src/developmental_read.rs"": ""5ba79b8e7ff36472c1113e7f07d660cd544bd2c03708019d67733826f1586584"", ""factory/src/conformance.rs"": ""483b758ac3b830e235e756386bca53ab6fe23787f35829947618874384552556""}}, ""last_reconciled_at"": ""2026-09-09T11:53:49.067727+00:00""}",
