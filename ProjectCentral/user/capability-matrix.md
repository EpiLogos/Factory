...
cap.factory.native-cli,capability,,,,[],A developer or Agent needs a stable way to inspect and operate Factory.,"factory capabilities declares public contracts; build snapshot/refresh, bounded developmental Project/Journey/Run/WorkflowUnit/ExecutionTelemetry reads, Action invocation, and verify operate or validate native providers.","Native snapshots, developmental and execution-telemetry readings, and receipts remain usable from shell and machine clients.",source-inspected; native CLI plus heterogeneous Agency correlation plus temporal/owner-telemetry integration evidence executed green 2026-09-08 (Factory all-target suite: 156 passed). Actuation/Workcell metric values plus AIKit consumption plus owner-world and desktop acceptance are not established.,agent-inference,../github-recovery-mirror/mirror/agent-system-design/issues/181.json;../github-recovery-mirror/mirror/agent-system-design/issues/181.comments.json,factory/src/cli.rs,factory/tests/native_cli.rs;factory/src/developmental_read.rs,factory.html#q1/product,,,"{""basis"": ""Source-recovered capability account reconciled against the #199 heterogeneous Agency and temporal/owner-telemetry slice."", ""converted_from_sha256"": ""99e4e8737c1c481bcd25a49a0a02f21cf3c34d78041d709e58fc566a5da0bf20"", ""cli_commands"": [""build.snapshot"", ""build.refresh"", ""action.list"", ""action.invoke"", ""verify"", ""development.project"", ""development.journey"", ""development.run"", ""development.workflow-units"", ""development.workflow-unit"", ""development.execution-telemetry"", ""development.action""], ""cli_exposure"": {""kind"": ""direct"", ""reason"": ""The native factory executable declares and handles these command families.""}, ""maintenance"": {""updated_at"": ""2026-09-08"", ""change_refs"": [""codex:thread:01a07608-d2ec-7b10-9713-74c445adf8a5"", ""../github-recovery-mirror/mirror/agent-system-design/issues/181.json"", ""reconcile:factory-pr-194"", ""https://github.com/EpiLogos/agent-system-design/pull/202"", ""https://github.com/EpiLogos/agent-system-design/issues/199""], ""code_basis"": {""factory/src/cli.rs"": ""5b9934d05215b8b7eb45db0afcbdabb2cbd15446dc03b17791600e246d3112ed""}}, ""last_reconciled_at"": ""2026-09-08T22:36:06.594172+00:00""}",
cap.factory.build-reading,capability,,,,[],A person needs the selected Project and Run’s current developmental state.,FactoryBuildFileProvider reads selected Build state; FactoryDevelopmentalState validates canonical Project/Journey/Run/WorkflowUnit/Agency/Execution relations and deterministically publishes bounded developmental and ExecutionTelemetry reads over owner-native refs.,"Revisioned readings expose canonical Journey/Run state, source-backed WorkflowUnit identity and Factory-established heterogeneous Agency/Execution correlations; temporal, Activity, Flow/source-change/DAY, body and Return refs retain their native provenance, while unavailable Actuation/Workcell usage remains explicit.",source-inspected; Factory all-target suite (156 tests) plus strict Clippy plus Draft 2020-12 schema validation executed green 2026-09-08. Actuation/Workcell metric values plus AIKit consumption plus owner-world and desktop acceptance are not established.,agent-inference,../github-recovery-mirror/mirror/agent-system-design/issues/143.json;../github-recovery-mirror/mirror/agent-system-design/issues/143.comments.json,factory/src/build_provider.rs;factory/src/developmental_read.rs,factory/tests/build_file_provider.rs;factory/src/developmental_read.rs;scripts/validate_factory_interop.py;contracts/factory/fixtures/developmental-read-cases.json;contracts/factory/fixtures/execution-telemetry-reading.json;contracts/factory/developmental-read.schema.json,factory.html#q1/product,,,"{""basis"": ""Source-recovered capability account reconciled against #199 heterogeneous Agency and temporal/owner-telemetry publication."", ""converted_from_sha256"": ""99e4e8737c1c481bcd25a49a0a02f21cf3c34d78041d709e58fc566a5da0bf20"", ""cli_commands"": [""build.snapshot"", ""build.refresh"", ""action.list"", ""development.project"", ""development.journey"", ""development.run"", ""development.workflow-units"", ""development.workflow-unit"", ""development.execution-telemetry""], ""cli_exposure"": {""kind"": ""direct"", ""reason"": ""Native commands return bounded owner readings over persisted source-backed state.""}, ""maintenance"": {""updated_at"": ""2026-09-08"", ""change_refs"": [""codex:thread:01a07608-d2ec-7b10-9713-74c445adf8a5"", ""../github-recovery-mirror/mirror/agent-system-design/issues/143.json"", ""reconcile:factory-pr-194"", ""https://github.com/EpiLogos/agent-system-design/pull/202"", ""https://github.com/EpiLogos/agent-system-design/issues/199""], ""code_basis"": {""factory/src/build_provider.rs"": ""527ce717e1f48a394385ddd9cd489b8b5b5c318c621162492df8ce72da83eab5"", ""factory/src/developmental_read.rs"": ""5844354763672579b83fecee282d64bd8fa32a05fc248a5f1bb3a1fdbbcca5db"", ""scripts/validate_factory_interop.py"": ""a44de78b9b14e49406aff8c63b9c8fb309e0fd0741e6a27b61bbb925eaafd4dd""}}, ""last_reconciled_at"": ""2026-09-08T22:36:06.594172+00:00""}",
