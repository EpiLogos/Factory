...
cap.factory.run-map,capability,,,,[],A developer needs an inspectable transformation whose identity survives execution changes.,Factory validates a source-owned Agent workflow and compiles stable workflow-unit refs and dependency/barrier/nesting relations into the canonical revisioned RunMap.,Atomic topology updates preserve Run identity; workflow-unit identity is deterministic from exact semantic source and provenance while runtime provider/session/Workcell changes remain outside it.,source-inspected; Factory all-target suite and strict Clippy executed green 2026-09-08. Runtime fork/barrier/cancellation enforcement plus owner-world and desktop acceptance are not established.,agent-inference,../github-recovery-mirror/mirror/agent-system-design/issues/4.json;../github-recovery-mirror/mirror/agent-system-design/issues/4.comments.json,factory/src/core/run/model.rs;factory/src/core/run/topology.rs;factory/src/workflow.rs,factory/tests/run_map.rs;factory/tests/workflow.rs;contracts/factory/agent-workflow-source.schema.json;contracts/factory/fixtures/agent-workflow-source.json,factory.html#q1/continuity,,,"{""basis"": ""Source-recovered capability account, reconciled against the implemented #197 workflow compiler and retained verification limits."", ""converted_from_sha256"": ""99e4e8737c1c481bcd25a49a0a02f21cf3c34d78041d709e58fc566a5da0bf20"", ""cli_commands"": [], ""cli_exposure"": {""kind"": ""library"", ""reason"": ""Workflow compilation and RunMap topology are native library contracts; the public Run reading exposes their resulting topology.""}, ""maintenance"": {""updated_at"": ""2026-09-08"", ""change_refs"": [""codex:thread:01a07608-d2ec-7b10-9713-74c445adf8a5"", ""../github-recovery-mirror/mirror/agent-system-design/issues/4.json"", ""reconcile:factory-pr-194"", ""https://github.com/EpiLogos/agent-system-design/issues/197""], ""code_basis"": {""factory/src/core/run/model.rs"": ""a1f4606fbfa0ef4c253ef5580e18a54dcdecf17f203eb47b6a9550a27d64ba1c"", ""factory/src/core/run/topology.rs"": ""930b4d55ebabba4f447ba6225d19d4b3f6a755a99bfc83baedef43f347452c82"", ""factory/src/workflow.rs"": ""7217067b307e062e56d0c45bbfa5d0a5746b7d66ecd868cd7eb7555db0d0db80""}}, ""last_reconciled_at"": ""2026-09-08T21:16:57.976151+00:00""}",
